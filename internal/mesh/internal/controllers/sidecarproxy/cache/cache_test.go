...
func TestUnified_AllMappingsToProxyStateTemplate(t *testing.T) {
	...
	compDestProxy1 := resourcetest.Resource(pbmesh.ComputedDestinationsType, sourceProxy1.Name).
		WithData(t, &pbmesh.ComputedDestinations{
	...
	compDestProxy2 := resourcetest.Resource(pbmesh.ComputedDestinationsType, sourceProxy2.Name).
		WithData(t, &pbmesh.ComputedDestinations{
			Destinations: []*pbmesh.Destination{
				{
					DestinationRef:  destServiceRef,
	...
	compDestProxy3 := resourcetest.Resource(pbmesh.ComputedDestinationsType, sourceProxy3.Name).
		WithData(t, &pbmesh.ComputedDestinations{
			Destinations: []*pbmesh.Destination{
				{
					DestinationRef:  destServiceRef,
	...
	compDestProxy4 := resourcetest.Resource(pbmesh.ComputedDestinationsType, sourceProxy4.Name).
		WithData(t, &pbmesh.ComputedDestinations{
			Destinations: []*pbmesh.Destination{
				{
					DestinationRef:  destServiceRef,
	...
	compDestProxy5 := resourcetest.Resource(pbmesh.ComputedDestinationsType, sourceProxy5.Name).
		WithData(t, &pbmesh.ComputedDestinations{
			Destinations: []*pbmesh.Destination{
				{
					DestinationRef:  destServiceRef,
	...
	compDestProxy6 := resourcetest.Resource(pbmesh.ComputedDestinationsType, sourceProxy6.Name).
		WithData(t, &pbmesh.ComputedDestinations{
			Destinations: []*pbmesh.Destination{
				{
					DestinationRef:  destServiceRef,
	...
	cache.TrackComputedDestinations(resourcetest.MustDecode[*pbmesh.ComputedDestinations](t, compDestProxy1))
	cache.TrackComputedDestinations(resourcetest.MustDecode[*pbmesh.ComputedDestinations](t, compDestProxy2))
	cache.TrackComputedDestinations(resourcetest.MustDecode[*pbmesh.ComputedDestinations](t, compDestProxy3))
	cache.TrackComputedDestinations(resourcetest.MustDecode[*pbmesh.ComputedDestinations](t, compDestProxy4))
	cache.TrackComputedDestinations(resourcetest.MustDecode[*pbmesh.ComputedDestinations](t, compDestProxy5))
	cache.TrackComputedDestinations(resourcetest.MustDecode[*pbmesh.ComputedDestinations](t, compDestProxy6))
